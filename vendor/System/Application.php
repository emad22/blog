...
class Application
{
    ...
    public function run()
    {
        ...
        //$this->baseUrl => http://localhost/blog-zohdy/
        // $this->url => '/admin'

        $this->file->call('App/routes.php'); // return  C:\wamp64\www\blog-zohdy\App\routes.php
    ...
    {
        spl_autoload_register([$this, 'autloader']);
    }
     ...
     * @return void
     */
    public function autloader($class)
    {
//        var_dump(strpos($class, 'App'));
//        die;
   ...
   public function share($key, $value)
   {
       ...
       $this->container[$key] = $value; // $this->container['file']  = 'object(System\File)[1]  >> private 'root' => string 'C:\wamp64\www\blog-zohdy' (length=24)';
   }
